...
O arquivo principal é o HTML em `docs/index.html`. A navegação também leva a `docs/hits-mundiais.html`, com um estudo exploratório de cinco hits mundiais e cinco faixas populares em gêneros específicos.
